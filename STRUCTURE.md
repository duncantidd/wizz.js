...
├── scripts/
│   ├── cli.js                            Public wizz init/build/dev/version command dispatcher
...
│   ├── initTemplates.js                  Canonical starter templates scaffolded by wizz init
