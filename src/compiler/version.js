...
//     `mountComponent(target)` default export, the returned `{ destroy() }`
//     handle, and the `__wizz*` root-node properties the framework consumes.
//     Within one major version, generated modules keep this surface and their
//     runtime behavior.
//
